  ...
  describe('/components/tabs/preview', () => {
    ...
    describe('when JavaScript is available', () => {
      ...
      it('should display the first tab panel', async () => {
        ...
        const tabPanelIsHidden = await page.evaluate(() => document.body.querySelector('.govuk-tabs > .govuk-tabs__panel').classList.contains('govuk-js-hidden'))
      ...
      it('should hide all the tab panels except for the first one', async () => {
        ...
        const tabPanelIsHidden = await page.evaluate(() => document.body.querySelector('.govuk-tabs > .govuk-tabs__panel ~ .govuk-tabs__panel').classList.contains('govuk-js-hidden'))
    ...
    describe('when a tab is pressed', () => {
      ...
      it('should display the tab panel associated with the selected tab', async () => {
        ...
        const secondTabPanelIsHidden = await page.evaluate(() => {
          ...
          return document.body.querySelector(`[id="${secondTabAriaControls}"]`).classList.contains('govuk-js-hidden')
        })
    ...
    describe('when a hash associated with a tab panel is passed in the URL', () => {
      it('should indicate the open state of the associated tab', async () => {
        ...
        const currentTabPanelIsHidden = await page.evaluate(() => document.getElementById('past-week').classList.contains('govuk-js-hidden'))
